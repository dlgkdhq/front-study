...
console.log(str.indexOf("!")); //문자가 없으면 -1을 return

// if(str.indexOf("!") == -1)

console.log(str.substring(0,4));    //문자 잘라내기 0부터 4까지, 4는 포함x
            //      0<=  <4
...
console.log(test);  //비파괴적, 원본데이터 안바뀜
...
console.log(today.getMonth());  //0 ~ 11    +1 
// console.log(today.getMonth()+1); //1 ~ 12
